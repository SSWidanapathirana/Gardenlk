        ...
        <?php foreach($data['seller'] as $seller ): ?>
            ...
            <table class="table1" style="border: 1px solid #958F8F ;width: 90%;">
                    ...
                    <a href="<?php echo URLROOT; ?>/sellers/sellershoppage/<?php echo $seller->seller_id; ?>">
                        <div>
                            <td><div><img src="<?php echo URLROOT ?>/public/img/<?php echo $seller->shopimg; ?>" class="prof-img"></td>
                            <td><h3 class="shopName"><?php echo $seller->businessName; ?></h3></div></td>
                            <td style="layout:fixed;overflow:hidden;word-wrap:break-word;"><div ><?php echo $seller->businessAddress; ?> </div></td>
                            <td colspan="4">
                                <a href="<?php echo URLROOT ?>/Pages/feedback?seller_id=<?php echo  $seller->seller_id ?>&order_id=<?php echo  $seller->order_id ?>"><input type="submit" name="Add Review" class="btn1" value="Add Review"/></a></td>           
