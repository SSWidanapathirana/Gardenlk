...
<body>
    <div class="container">
        ...
        <div><img src="<?php echo URLROOT ?>/public/img/sellersBanner.jpg" ><h1 class="sellersBanner">SELLERS</h1></div>
    </div>
        <div class="wrapper">
            
                <div> </div>
                <div class="box2"><h3></h3></div>
                ...
                <?php foreach($data['seller'] as $seller ): ?>
                    <a href="<?php echo URLROOT; ?>/sellers/sellershoppage/<?php echo $seller->seller_id; ?>">
                        <div class="box">
                            <div><img src="<?php echo URLROOT ?>/public/img/<?php echo $seller->shopimg; ?>" class="prof-img"><h3 class="shopName"><?php echo $seller->businessName; ?></h3></div>
