...
<div class="container">
    ...
    <div class="row3" id="ex1">
        <table>
            ...
            <td><?php echo $plant->quantity; ?></td>
            <td>
                <input type="submit" name="remove" class="btn1" value="Remove" /><br>
                <input type="submit" name="remove" class="btn2" value="Hide" /><br>
                <input type="submit" name="addplant" class="updatebtn" value="Update" onclick="location.href='<?php echo URLROOT; ?>/Sellers/addPlant'"/><br>
            </td>
