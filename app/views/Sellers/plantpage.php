...
<body>
    <div class="container">
        <div><img src="<?php echo URLROOT ?>/public/img/plantspage1.jpg" style="width:100%; height:500px"><h1 class="plantsTopic">PLANTS</h1></div>
        
        <div class="wrapper"> 
            <div class="leftcol">
                <h3>Plant Category</h3><br>
                    <a href="<?php echo URLROOT ?>/Sellers/category_tablePlant#TOP"><div class="box">Table Plant</div></a>
