    ...
    <section>
        ...
        <div>
            <form action="<?php echo URLROOT; ?>/pages/feedback" method="post">
                ...
                <textarea id="feedback" name="feedback_msg1" placeholder="Have any feedbacks" style="height:100px;width: 80%;margin:60px 30px 30px 30px"></textarea>
        ...
        <div>
            ...
            <textarea id="feedback" name="feedback_msg2" placeholder="Have any feedbacks" style="height:100px;width: 80%;margin:80px 30px 30px 30px"></textarea>
        </div>
    </section>
