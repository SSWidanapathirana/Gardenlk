...
<div class="header-menu">
    <div class="top">
        ...
        <div class="hleft">
            <a href="<?php echo URLROOT; ?>/pages/index"><div class="hsocial-item"><span class="header-menu-text">Home </span></div></a>
            <a href="<?php echo URLROOT; ?>/Sellers/plantpage"><div class="hsocial-item"><span class="header-menu-text">Plants </span></div></a>
            <a href="<?php echo URLROOT; ?>/Sellers/sellerpage"><div class="hsocial-item"><span class="header-menu-text">Sellers </span></div></a>
