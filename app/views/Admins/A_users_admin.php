  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-topic">
        <span class="dashboard">Manage Users - Admin</span>
      </div>
      ...
      <div class="boxes">
        <div class="userdetails box">
          ...
          <ul class="details">
            ...
            <li>
              <button class="buttonselection buttonselection1" onclick="document.location='<?php echo URLROOT ?>/admins/A_users_updateuser_admin'">Update</button>
